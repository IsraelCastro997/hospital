<template>
  <div class="container-fluid">
    <h2 class="text-dark m-4">Usuarios</h2>
            ...
            <table class="table my-0">
              ...
              <tbody>
                ...
                >
                  ...
                  <td>
                    {{ props.roles.length > 0 ? props.roles[0].name : "-" }}
                  </td>
                  <td>
...
export default {
  ...
  methods: {
    onClickEdit($idy) {
      const ediId = $idy;
      window.location.href = "/usuarios/editar/" + ediId + "/";
      //this.$emit("edit", ediId);
    },
    onClickDetails($idy) {
      const ediId = $idy;
      window.location.href = "/usuarios/detalle/" + ediId + "/";
    ...
    sort($op) {
      ...
      if ($op == 1) {
        ...
        if (this.asc) {
          this.aux.sort((a, b) =>
            (a.roles.length > 0 ? a.roles[0].name : "") <
            (b.roles.length > 0 ? b.roles[0].name : "")
              ? -1
              : Number(
                  (a.roles.length > 0 ? a.roles[0].name : "") >
                    (b.roles.length > 0 ? b.roles[0].name : "")
